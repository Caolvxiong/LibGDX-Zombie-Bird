...
import com.wangwenchao.TweenAccessors.Value;
import com.wangwenchao.TweenAccessors.ValueAccessor;
import com.wangwenchao.gameobjects.Bird;
import com.wangwenchao.gameobjects.Grass;
import com.wangwenchao.gameobjects.Pipe;
...
public class GameRenderer {
	...
	private TextureRegion skullUp, skullDown, bar, ready, zbLogo, gameOver, highScore, scoreboard, star, noStar, retry;
	...
	public GameRenderer(GameWorld world, int gameHeight, int midPointY) {
		...
		this.menuButtons = ((InputHelper) Gdx.input.getInputProcessor()).getMenuButtons();
